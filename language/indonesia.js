...
exports.menunya = (salam, pushname, botname) =>{
	return`𝗵𝗮𝗶 𝘀𝘆𝗴 ${pushname} 👋 𝘀𝗲𝗹𝗮𝗺𝗮𝘁 ${salam} , 
𝘀𝗮𝘆𝗮 ${botname}, 𝗮𝘀𝗶𝘀𝘁𝗲𝗻 𝗸𝗮𝗺𝘂<3

𝘂𝗻𝘁𝘂𝗸 𝗺𝗲𝗹𝗶𝗵𝗮𝘁 𝗳𝗶𝘁𝘂𝗿 𝗯𝗼𝘁 𝘁𝗲𝗸𝗮𝗻 𝗹𝗶𝘀𝘁 𝗰𝗼𝗺𝗺𝗮𝗻𝗱✍︎

𝗷𝗼𝗶𝗻 𝗴𝗿𝘂𝗽 𝗯𝗼𝘁 𝗸𝘂☕︎
https://chat.whatsapp.com/JOxS05d1WWO529F40SEVEa

𝗯𝗮𝗻𝘁𝘂 𝗳𝗼𝗹𝗼𝘄 𝗶𝗻𝘀𝘁𝗮𝗴𝗿𝗮𝗺 𝗸𝘂 𝗱𝗶 𝗯𝗮𝘄𝗮𝗵🙇‍♀️
